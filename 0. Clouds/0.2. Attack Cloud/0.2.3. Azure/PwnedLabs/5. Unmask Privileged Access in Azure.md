...
```
Description and relationships are posted here. [../Azure Services/Azure Entra](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Entra.md>)
...
[../Azure General/Azure Network](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Azure Network.md>)
...
Once again, more information regarding the Key Vault can be found here. [../Azure Services/Azure Key Vault](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Key Vaults.md>)
...
[../Azure General/Tool- RoadRecon](<../Tool- RoadRecon.md>)
...
We can do the same thing with az. [../Azure General/AZ CLI](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/AZ CLI.md>)
...
This is a great start[../Azure Services/Azure Key Vault](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Key Vaults.md>)
...
[../Azure Services/Azure Automation](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Automation.md>)


Basically, it is a centralized server for scheduled jobs, also it may have good information. It is crucial to check shared resources on automationAccount. [../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Automation#1.2 Shared Resources|Azure Automation](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Automation.md#12-shared-resourcesazure-automation>)
