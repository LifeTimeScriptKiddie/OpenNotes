---
{"dg-publish":true,"permalink":"/1-hack-like-a-script-kiddie/clouds/azure/pwned-labs/6-azure-recon-to-foothold-and-profit/","noteIcon":"","created":"2025-04-15T14:11:19.595-04:00"}
---
...
>
Learn more about getuserrealm.srf from [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/IAM/Security Token Service#1. What is STS?\|Security Token Service]]. 
...
[[../Tool - Azrecon.sh\|../Azure General/Tool - Azrecon.sh]]
...
The tool [[../Tool - AADInternal\|Tool - AADInternal]] by Dr. Nestori Syynimaa is an excellent resource for gathering information. One of the most impressive aspects of this tool is the kill chain, which can be found on his web page. A markdown version is available here: [[../Tool - AADInternal#Markdown Table\|Tool - AADInternal]]. Not sure where to start? Use this table or follow a mermaid chart from [[../Tool - AADInternal#Mermaid\|here]].
...
Let's use [[../Tool - AADInternal#1. Outsider\|Tool - AADInternal Outsider]] to search for the username. We'll feed the possible username list into Invoke-AADIntUserEnumerationAsOutsider. And voilà! We have Yuki's username.
...
[[../Enumerate with credentials\|Enumerate with credentials]] is a great starting point. I normally start with the account itself, then move on to the tenant, subscription, and resources. 
...
It appears that Yuki's account has a web app resource.  Based on the Microsoft website, and [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure App Services\|Azure App Services]], this resource seems to provide web application capabilities to the customer.
```powershell
PS> az resource list
[
  {
...
By clicking the Files REST API link, we can see an interesting file containing credentials and an SQL command. Let's check it out! [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure SQL#3.1 sqlcmd\|Azure SQL cmd]]
...
Once again when searching for data in a database, the good approach is to start from database--> table --> column. More information can be found here [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure SQL#3.1 sqlcmd\|Azure SQL]]. 
...
Let's get usernames via [[../Tool - AADInternal\|Tool - AADInternal]]. 
...
## 6.1 Get users 
Now that we have a list of users and the password for dbuser, let's give it a shot using [[../Azure General/IAM/Password spray tools\|Password spray tools]]. The goal here is to find a user with the same password.


[[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/AZ CLI\|AZ CLI]]
```powershell
