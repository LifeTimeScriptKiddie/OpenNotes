...
More information is available here: [../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Entra#2. Administrative Units|Entra AU](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Entra.md#2-administrative-unitsentra-au>).
...
## 4.1 Web app
Let's dig deeper. [Azure App Services](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure App Services.md>)
...
Thanks to [Azure REST API with Azure CLI](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Azure REST API with Azure CLI.md>). We can directly query blob information. Before we query blob information, let's ask ourselves. **What is blob?** 
...
In Azure, blobs are stored in [../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Storage Account#1. What is Azure Storage ?|Azure Storage Account](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Storage Account.md#1-what-is-azure-storage-azure-storage-account>).  
...
From the [8. Execute Azure Credential Shuffle to Achieve Objectives#4.5.2 Role and Scope|#4.5.2 Role and Scope](#452-role-and-scope452-role-and-scope) query, we have the Container and account names. Let's use AZ CLI to see/download what blobs are stored under the account `storageqaenv`. 
```bash
...
Briefly, `new-PsSession`  creates a persistent connection using either winrm or ssh . This leads us to the next question. What is winrm? It is a protocol used by developers and IT professionals to manage windows system. Normally Port 5985 or 5986.  See more from [Windows Remote Management](<../../../../6. Windows OS/6.1 Learn Windows/1. Windows Basic/Windows Remote Management.md>). 
...
So, we need to do this manually! [Enumerate Windows](<../../../../6. Windows OS/6.2 Attack Windows/Enumerate Windows.md>).
...
Detailed information can be found here: [../../../../6. Windows OS/6.1 Learn Windows/1. Windows Basic/Windows User Rights#Dangerous Windows User Privileges|Windows User Rights](<../../../../6. Windows OS/6.1 Learn Windows/1. Windows Basic/Windows User Rights.md#dangerous-windows-user-privilegeswindows-user-rights>)

Detail information is here. [../../../../6. Windows OS/6.1 Learn Windows/1. Windows Basic/Windows User Rights#Dangerous Windows User Privileges|Windows User Rights](<../../../../6. Windows OS/6.1 Learn Windows/1. Windows Basic/Windows User Rights.md#dangerous-windows-user-privilegeswindows-user-rights>)
...
See more about Resource Manager [here](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Resource Manager.md>). 
...
Azure storage service is like a ....gigantic somewhat organized space. It can contain blobs, files, queues, and tables. More info is [../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Storage Account#Storage Browser|here](<../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure Storage Account.md#storage-browserhere>). 
...
[8. Execute Azure Credential Shuffle to Achieve Objectives#3. Administrative Units|Administrative units](#3-administrative-unitsadministrative-units) is something we have check earlier. Let's use MS Graph to check that out.
