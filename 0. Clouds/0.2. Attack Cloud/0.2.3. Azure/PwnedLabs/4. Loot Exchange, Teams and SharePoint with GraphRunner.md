---
{"dg-publish":true,"permalink":"/1-hack-like-a-script-kiddie/clouds/azure/pwned-labs/4-loot-exchange-teams-and-share-point-with-graph-runner/","noteIcon":"","created":"2025-04-15T14:11:19.594-04:00"}
---
...
[[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph\|../Azure Services/Microsoft Graph]]
...
[[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure API Management\|../Azure Services/Azure API Management]]
...
1. **Get credentials.**
2. **Check MFA-enabled/disabled services** using MFA Sweeps. [[4. Loot Exchange, Teams and SharePoint with GraphRunner#1. MFA Sweeps\|#1. MFA Sweeps]]
3. **Log in and retrieve assigned Microsoft 365 licenses.** [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph\|../Azure Services/Microsoft Graph]]
   ```powershell
   PS> Connect-MgGraph
...
4. **Enumerate Graph API.** [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph\|../Azure Services/Microsoft Graph]]
...
GraphRunner tool information can be found here: [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph#4.2 Complete Workflow of System Information Gaining\|../Azure Services/Microsoft Graph#4.2 Complete Workflow of System Information Gaining]].

## 2.1 Start Authentication with GraphRunner

After logging in, the first step is to authenticate with the system. [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph#4.2.1 **Authentication Flow**\|../Azure Services/Microsoft Graph#4.2.1 **Authentication Flow**]].
...
Let's use the [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.1. Azure General/Microsoft Graph#4.2.2 Recon & Enumeration Flow\|../Azure Services/Microsoft Graph#4.2.2 Recon & Enumeration Flow]].
...
It seems like `797f4846-ba00-4fd7-ba43-dac1f8f63013` is generally Azure API Management, and `14d82eec-204b-4c2f-b7e8-296a70dab67e` is the SDK App. [[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/SDKs\|../Azure Services/SDKs]]
...
Earlier in [[4. Loot Exchange, Teams and SharePoint with GraphRunner#1. MFA Sweeps\|#1. MFA Sweeps]], Graph API and API management were the ones where MFA was not enabled.
...
One key point was `14d82eec-204b-4c2f-b7e8-296a70dab67e` was previously identified with `Invoke-DumpCAPS` command. [[4. Loot Exchange, Teams and SharePoint with GraphRunner#2.2.2 Invoke-DumpCAPS\|#2.2.2 Invoke-DumpCAPS]]. 
...
[[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure SQL#2.1 For database\|../Azure Services/Azure SQL#2.1 For database]]
...
[[../../../0.1. Learn Cloud/0.1.2 Azure/0.1.2.2. Azure Services/Azure SQL#3.1 sqlcmd\|../Azure Services/Azure SQL#3.1 sqlcmd]]
...
From the exercise, [[4. Loot Exchange, Teams and SharePoint with GraphRunner\|4. Loot Exchange, Teams and SharePoint with GraphRunner]]
```powershell
